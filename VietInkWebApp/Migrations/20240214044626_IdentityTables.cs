        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitsInStock = table.Column<int>(type: "int", nullable: true, defaultValueSql: "((0))"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipCity = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    ShipRegion = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    ShipPostalCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    ShipCountry = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    PhoneNumber = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Note = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    Discount = table.Column<double>(type: "float", nullable: true, defaultValueSql: "((0))")
                },
                constraints: table =>
                {
